#!/usr/bin/env bash
# Native core engine: compile tools/azl_core_engine.c with selftest and run.
...
mkdir -p .azl
if ! gcc -std=c11 -Wall -Wextra -Werror -O2 -pthread -DAZL_CORE_ENGINE_SELFTEST \
  tools/azl_core_engine.c -o .azl/azl_core_engine_selftest; then
