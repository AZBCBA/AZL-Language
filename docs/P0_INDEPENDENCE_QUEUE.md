...
- [x] 12. Refresh roadmap/TIER_B F-gate ranges when the suite moves — **done** through **F201** (2026-03-24).
...
- [x] **F183** — inner **`let ::… = …`** in **`listen { … }`** — shipped (**798–800**).
- [x] **F184** — inner **`name ( )`** → **`listen|…|call|…`** — shipped (**801–803**).
- [x] **F185** — **`execute_ast`** **`listen|…|call|…`** stub — shipped (**804–806**).
- [x] **F186** — inner **`name ( '…' )`** → **`listen|…|call|…|payload`** — shipped (**807–809**).
- [x] **F187** — **`execute_ast`** **`listen|…|call|…|arg`** stub (fn body + arg lines) — shipped (**810–812**).
- [x] **F188** — top-level **`call|…|payload`** from **`name ( '…' )`** — shipped (**813–815**).
...
- [x] **F196** — dual listen-inner **`call`** with **identifier** payload — shipped (**837–839**).
...
- [x] **F201** — listen-inner **`say`** then **`call`** — shipped (**852–854**).
...
- [x] 33. Byte-identical stdout — **F173–F201** match (incl. **F181**–**F201** blocks).
...
**Last updated:** 2026-03-24 (F173–F201 incl. **F201** listen **`say`** then **`call`**, **F200** top **`say`** then **`call`**, **F198**/**F199** **`call`**+**`say`** mix, **F196**/**F197**/**F194**/**F195**/**F192**/**F193** dual **`call`** rows, **F190**/**F191**, **F188**/**F189**, **F186**/**F187**, **F184**/**F185**, **F183** **`let`**, **F182** nested **`listen`**, **F181** **`return`** stub).
