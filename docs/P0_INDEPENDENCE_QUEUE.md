...
- [x] 12. Refresh roadmap/TIER_B F-gate ranges when the suite moves — **done** through **F197** (2026-03-24).
...
- [x] 33. Byte-identical stdout — **F173–F197** match (incl. **F181**–**F197** blocks).
...
**Last updated:** 2026-03-24 (F173–F197 incl. **F196**/**F197** dual **`call`** identifier payloads, **F194**/**F195** string payloads, **F192**/**F193** empty **`call`**, **F190**/**F191**, **F188**/**F189**, **F186**/**F187**, **F184**/**F185**, **F183** **`let`**, **F182** nested **`listen`**, **F181** **`return`** stub).
