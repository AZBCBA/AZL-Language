...
- [x] 12. Refresh roadmap/TIER_B F-gate ranges when the suite moves — **done** through **F189** (2026-03-24).
...
- [x] 33. Byte-identical stdout — **F173–F189** match (incl. **F181**–**F189** blocks).
...
**Last updated:** 2026-03-24 (F173–F189 incl. **F188**/**F189** top-level **`call`** string parse + **`execute_ast`** **`call|…|arg`**, **F186**/**F187** listen-inner **`call`**, **F184**/**F185**, **F183** **`let`**, **F182** nested **`listen`**, **F181** **`return`** stub).
