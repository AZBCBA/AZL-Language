...
| **Correctness** | **Parity gates F2–F67** (native **`check_azl_native_gates.sh`**) prove **subset** C↔Python behavior on **fixtures only**. **No** repo-wide proof that RepertoireField or LHA3 semantics match a written spec. |
