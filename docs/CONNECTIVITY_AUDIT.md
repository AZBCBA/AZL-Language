...
| 4 | `scripts/verify_azl_interpreter_semantic_spine_behavior_smoke.sh` | Tier B **P0.1c**: stub + harness + interpreter; **seven** **`emit interpret`** (two duplicate-**`code`** cache pairs + multi-line **`say`** + duplicate **`AZL_S6_ONLY`**); **548–561** |
