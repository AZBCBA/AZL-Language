...
| 4 | `scripts/verify_azl_interpreter_semantic_spine_behavior_smoke.sh` | Tier B **P0.1c**: stub + harness + interpreter; **five** **`emit interpret`** (cache round-trip + multi-line embedded **`say`** depth); **548–560** |
