...
| 4 | `scripts/verify_azl_interpreter_semantic_spine_behavior_smoke.sh` | Tier B **P0.1c**: stub + harness + interpreter; **`emit interpret`** through tokenize/parse/execute/**execute_complete**; **548–555** |
