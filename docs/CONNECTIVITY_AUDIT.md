...
| 4 | `scripts/verify_azl_interpreter_semantic_spine_behavior_smoke.sh` | Tier B **P0.1c**: stub + harness + interpreter; **three** **`emit interpret`** (cache round-trip + two-line embedded **`say`** depth); **548–558** |
