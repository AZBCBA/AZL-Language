...
| 4 | `scripts/verify_azl_interpreter_semantic_spine_behavior_smoke.sh` | Tier B **P0.1c**: stub + harness + interpreter; **six** **`emit interpret`** (cache round-trip + multi-line embedded **`say`** depth + **`AZL_S6_ONLY`**); **548–561** |
