...
| **825** | C minimal **`p0_semantic_parse_tokens_listen_dual_call`** failed, wrong stdout, or missing dual **`listen|f192|call|…`** / **`P0_SEM_F192_OK`** — requires **`AZL_USE_VM` unset** (**F192**) |
| **826** | Python spine host **`p0_semantic_parse_tokens_listen_dual_call`** failed (**F192**) |
| **827** | C vs Python **`p0_semantic_parse_tokens_listen_dual_call`** stdout mismatch (**F192**) |
| **828** | C minimal **`p0_semantic_parse_tokens_dual_top_call`** failed, wrong stdout, or missing dual **`call|…`** / **`P0_SEM_F193_OK`** — requires **`AZL_USE_VM` unset** (**F193**) |
| **829** | Python spine host **`p0_semantic_parse_tokens_dual_top_call`** failed (**F193**) |
| **830** | C vs Python **`p0_semantic_parse_tokens_dual_top_call`** stdout mismatch (**F193**) |
| **831** | C minimal **`p0_semantic_parse_tokens_listen_dual_call_string`** failed, wrong stdout, or missing dual **`listen|f194|call|…|…`** / **`P0_SEM_F194_OK`** — requires **`AZL_USE_VM` unset** (**F194**) |
| **832** | Python spine host **`p0_semantic_parse_tokens_listen_dual_call_string`** failed (**F194**) |
| **833** | C vs Python **`p0_semantic_parse_tokens_listen_dual_call_string`** stdout mismatch (**F194**) |
| **834** | C minimal **`p0_semantic_parse_tokens_dual_top_call_string`** failed, wrong stdout, or missing dual **`call|…|…`** / **`P0_SEM_F195_OK`** — requires **`AZL_USE_VM` unset** (**F195**) |
| **835** | Python spine host **`p0_semantic_parse_tokens_dual_top_call_string`** failed (**F195**) |
| **836** | C vs Python **`p0_semantic_parse_tokens_dual_top_call_string`** stdout mismatch (**F195**) |
| **837** | C minimal **`p0_semantic_parse_tokens_listen_dual_call_ident`** failed, wrong stdout, or missing dual **`listen|f196|call|…|::…`** / **`P0_SEM_F196_OK`** — requires **`AZL_USE_VM` unset** (**F196**) |
| **838** | Python spine host **`p0_semantic_parse_tokens_listen_dual_call_ident`** failed (**F196**) |
| **839** | C vs Python **`p0_semantic_parse_tokens_listen_dual_call_ident`** stdout mismatch (**F196**) |
| **840** | C minimal **`p0_semantic_parse_tokens_dual_top_call_ident`** failed, wrong stdout, or missing dual **`call|…|::…`** / **`P0_SEM_F197_OK`** — requires **`AZL_USE_VM` unset** (**F197**) |
| **841** | Python spine host **`p0_semantic_parse_tokens_dual_top_call_ident`** failed (**F197**) |
| **842** | C vs Python **`p0_semantic_parse_tokens_dual_top_call_ident`** stdout mismatch (**F197**) |
| **843** | C minimal **`p0_semantic_parse_tokens_listen_call_then_say`** failed, wrong stdout, or missing **`listen|…|call|…`** / **`listen|…|say|…`** / **`P0_SEM_F198_OK`** — requires **`AZL_USE_VM` unset** (**F198**) |
| **844** | Python spine host **`p0_semantic_parse_tokens_listen_call_then_say`** failed (**F198**) |
| **845** | C vs Python **`p0_semantic_parse_tokens_listen_call_then_say`** stdout mismatch (**F198**) |
| **846** | C minimal **`p0_semantic_parse_tokens_top_call_then_say`** failed, wrong stdout, or missing **`call|…`** / **`say|…`** / **`P0_SEM_F199_OK`** — requires **`AZL_USE_VM` unset** (**F199**) |
| **847** | Python spine host **`p0_semantic_parse_tokens_top_call_then_say`** failed (**F199**) |
| **848** | C vs Python **`p0_semantic_parse_tokens_top_call_then_say`** stdout mismatch (**F199**) |
| **849** | C minimal **`p0_semantic_parse_tokens_top_say_then_call`** failed, wrong stdout, or missing **`say|…`** / **`call|…`** / **`P0_SEM_F200_OK`** — requires **`AZL_USE_VM` unset** (**F200**) |
| **850** | Python spine host **`p0_semantic_parse_tokens_top_say_then_call`** failed (**F200**) |
| **851** | C vs Python **`p0_semantic_parse_tokens_top_say_then_call`** stdout mismatch (**F200**) |
| **852** | C minimal **`p0_semantic_parse_tokens_listen_say_then_call`** failed, wrong stdout, or missing **`listen|…|say|…`** / **`listen|…|call|…`** / **`P0_SEM_F201_OK`** — requires **`AZL_USE_VM` unset** (**F201**) |
| **853** | Python spine host **`p0_semantic_parse_tokens_listen_say_then_call`** failed (**F201**) |
| **854** | C vs Python **`p0_semantic_parse_tokens_listen_say_then_call`** stdout mismatch (**F201**) |
