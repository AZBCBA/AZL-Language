...
- **Open next (documented):** **`listen for "execute"`** / **`execute_complete`** and VM branch shapes (**F86+**) — **[RUNTIME_SPINE_DECISION.md](RUNTIME_SPINE_DECISION.md)** “Open next” + roadmap phase **E**.
