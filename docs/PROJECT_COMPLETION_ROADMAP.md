...
|-------|--------|---------------------------------------------------|----------------------|
| **A — Parity safety net** | C ↔ Python stay aligned on the **contracted** subset | `bash scripts/check_azl_native_gates.sh` exits **0** (includes **F**, **F2–F162**, **G**, **G2**, **H**, engine build as wired) | Native gates |
