...
2. **Operational strength** — gates script; **`verify_azl_interpreter_semantic_spine_smoke.sh`** (P0.1b inside **`run_full_repo_verification.sh`**); `verify_native_runtime_live.sh`; full **`run_full_repo_verification.sh`**; [ERROR_SYSTEM.md](ERROR_SYSTEM.md).  
