...
1. **Predictable semantics** — [language/AZL_CURRENT_SPECIFICATION.md](language/AZL_CURRENT_SPECIFICATION.md); gates F2, F3, G; semantic parity slices F4–F166 (C minimal vs Python **`minimal_runtime`**, through **`::parse_tokens`** **F166** in **`check_azl_native_gates.sh`**).  
