...
1. **Predictable semantics** — [language/AZL_CURRENT_SPECIFICATION.md](language/AZL_CURRENT_SPECIFICATION.md); gates F2, F3, G; semantic parity slices F4–F76 (C minimal vs Python **`minimal_runtime`**).  
