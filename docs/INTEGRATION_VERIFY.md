...
4. **`verify_azl_interpreter_semantic_spine_behavior_smoke.sh`** — stub + harness + interpreter; **six** **`emit interpret`** (cache round-trip + multi-line depth **`say`** + **`AZL_S6_ONLY`**); **ERROR_SYSTEM** **548–561**  
