...
4. **`verify_azl_interpreter_semantic_spine_behavior_smoke.sh`** — stub + harness + interpreter; **seven** **`emit interpret`** (**≥4** **`(cache hit)`** + multi-line depth **`say`** + duplicate **`AZL_S6_ONLY`**); **ERROR_SYSTEM** **548–561**  
