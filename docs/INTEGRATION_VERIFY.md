...
4. **`verify_azl_interpreter_semantic_spine_behavior_smoke.sh`** — stub + harness + interpreter; **five** **`emit interpret`** (cache round-trip + multi-line depth **`say`**); **ERROR_SYSTEM** **548–560**  
