...
4. **`verify_azl_interpreter_semantic_spine_behavior_smoke.sh`** — stub + harness + interpreter; **`emit interpret`** through tokenize/parse/execute/**execute_complete** (**ERROR_SYSTEM** **548–555**)  
