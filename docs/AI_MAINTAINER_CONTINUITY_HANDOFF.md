...
| 2026-03-22 | Native semantic parity **F74–F80** (tokenize + cache/miss): **F74–F79** as before (**323–340**); **F80** cache **`!= null`** branch + **`tok_misses`** on miss (**341–343**, **P0tokcache**). **`make verify`** green; cross-docs + **CHANGELOG** updated. |
