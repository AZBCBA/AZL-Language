...
| 2026-03-22 | Native semantic parity **F74–F76** (tokenize-line-shaped): **F74** **`in_string`** / quote + **`::handled`** (**323–325**, **P0str**); **F75** **`tz|…`** token **`.push`** + **`::acc.concat`** (**326–328**, **P0tz**); **F76** **`::line + 1`** + **`::current + ::c`** (**329–331**, **P0inc**). **`make verify`** green; cross-docs + **CHANGELOG** updated. |
