...
| 2026-03-22 | Native semantic parity **F74–F81** (tokenize + cache): **F74–F79** (**323–340**); **F80** cache miss + **`tok_misses`** (**341–343**, **P0tokcache**); **F81** cache hit + **`tok_hits`** + **`::tokens`** from **`::cached_tok`** (**344–346**, **P0tokhit**). **`make verify`** green; cross-docs + **CHANGELOG** updated. |
