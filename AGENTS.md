...
4. **`docs/PROJECT_COMPLETION_ROADMAP.md`** — P0–P5 queue and gates.
...
**`scripts/check_azl_native_gates.sh`** gates **F2–F67** diff **`tools/azl_interpreter_minimal.c`** vs **`tools/azl_runtime_spine_host.py`** on **`azl/tests/p0_semantic_*.azl`** (and **`c_minimal_link_ping.azl`** for F2). New behavior needs a fixture + gate block + new **§ Native gates** rows in **`docs/ERROR_SYSTEM.md`** (avoid exit collisions). **F9** stdout mismatch = **59** (not **`verify_native_runtime_live.sh`** **69**). **F10–F14** = **111–125**; **F15–F18** = **126–137**; **F19–F20** = **138–143**; **F21** = **144–146**; **F22** = **147–149**; **F23–F25** = **150–158**; **F26–F28** = **159–167**; **F29–F31** = **168–176**; **F32–F35** = **177–188**; **F36–F39** = **189–200**; **F40–F43** = **201–212**; **F44–F47** = **213–224**; **F48–F51** = **225–236**; **F52–F55** = **237–248**; **F56–F58** = **249–257**; **F59–F61** = **258–266**; **F62** = **267–269**; **F63** = **270** / **272** / **273** (skip **271** — **`CODEC_DECOMPRESS_FAILED`**); **F64** = **274–276**; **F65–F67** = **277–285**.
