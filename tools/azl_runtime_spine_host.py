...
and asserts six interpret passes + execute_complete + in-file (cache hit) lines + multi-line embedded say depth markers + sixth literal say marker (ERROR_SYSTEM.md exits 548–561).
